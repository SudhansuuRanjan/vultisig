...
const NavBar = () => {
  ...
  return (
    <nav className='flex fixed w-full justify-between z-50 items-center py-3.5 px-6 backdrop-blur-md border-b border-design-border bg-opacity-10 bg-design-dark/50'>
      ...
      <div className='lg:flex md:flex hidden items-center lg:gap-14 md:gap-10'>
        <div className='flex text-[1.1rem] items-center lg:gap-4 md:gap-3'>
