...
const HeroSection = () => {
  return (
    <section className="relative bg-image pt-32 pb-20 px-6 md:px-12 overflow-hidden">
      <div data-aos="zoom-in" className="container mx-auto">
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <a href='https://airdrop.vultisig.com/leaderboard' target='_blank' className='border m-auto mb-3 border-design-border hover:bg-design-card-hover cursor-pointer hover:scale-[102%] transition w-fit px-1 py-1 rounded-full flex items-center gap-2'>
