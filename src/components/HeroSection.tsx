...
const HeroSection = () => {
  return (
    <section className="relative bg-image pt-32 pb-20 px-1 md:px-6 overflow-hidden">
      <div data-aos="zoom-in" className="container mx-auto">
        <div className="lg:max-w-3xl md:max-w-3xl max-w-full mx-auto text-center relative z-10">
          <a href='https://airdrop.vultisig.com/leaderboard' target='_blank' className='border lg:text-base md:text-base text-sm m-auto mb-3 border-design-border hover:bg-design-card-hover cursor-pointer lg:hover:scale-[105%] md:hover:scale-[105%] hover:scale-[93%] transition w-fit px-1 py-1 rounded-full flex items-center gap-2 lg:scale[100%] md:scale-[100%] scale-[85%]'>
