...
const HeroSection = () => {
  return (
    <section className="relative pt-32 pb-20 px-6 md:px-12 overflow-hidden">
      ...
      {/* Glow effect */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] opacity-20 rounded-full bg-gradient-circle animate-pulse-glow"></div>
      
      {/* Circle outline */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] border border-design-accent/30 rounded-full"></div>
    </section>
  );
};
